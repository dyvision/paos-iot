...
class commands:
    ...
    def update(self):
        os.popen('git reset --hard HEAD;git pull')
        return
...
class blue:
    ...
    def set(self, device):
        result = os.system('echo "scan on | bluetoothctl;sleep 5;pair '+device+'" | bluetoothctl; sleep 10; echo "trust '+device+'" | bluetoothctl;echo "connect '+device+'" | bluetoothctl').read()
        return result
